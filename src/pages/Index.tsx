...
const CITIES = [
  ...
  },
  {
    ...
    subtitle: "Основан в 1703 году",
    image: "https://cdn.poehali.dev/projects/d6f85955-8cfe-4b44-937a-8f96d0f8ace6/files/15d2d4fe-27ae-4b09-81e7-b61d2cff9518.jpg",
    quests: 11,
    places: 61,
    weather: "−2°C · Туман",
    weatherIcon: "CloudFog",
    description: "Северная столица — город белых ночей, каналов и имперского величия.",
    color: "#5B6B8B",
  },
  {
    id: "kzn",
    name: "Казань",
    subtitle: "Основана в 1005 году",
    image: "https://cdn.poehali.dev/projects/d6f85955-8cfe-4b44-937a-8f96d0f8ace6/files/c2942703-144c-40f7-8d98-8a6fdabe694b.jpg",
    quests: 6,
    places: 19,
    weather: "−7°C · Снег",
    weatherIcon: "Snowflake",
    description: "Место встречи двух культур — татарской и русской, третья столица России.",
    color: "#7B5B3A",
  },
  {
    id: "vng",
    name: "Великий Новгород",
    subtitle: "Основан в 859 году",
    image: "https://cdn.poehali.dev/projects/d6f85955-8cfe-4b44-937a-8f96d0f8ace6/files/2470c6d4-1f25-4408-9464-2e01ba5ae7ff.jpg",
    quests: 5,
    places: 16,
    weather: "−4°C · Облачно",
    weatherIcon: "Cloud",
    description: "Древнейший город России — колыбель русской государственности и вечевой республики.",
    color: "#5A6645",
  },
  {
    id: "szl",
    name: "Суздаль",
    subtitle: "Основан в 999 году",
    image: "https://cdn.poehali.dev/projects/d6f85955-8cfe-4b44-937a-8f96d0f8ace6/files/58c411e6-849e-416b-8ab2-a40f14f1d177.jpg",
    quests: 4,
    places: 12,
    weather: "−6°C · Снег",
    weatherIcon: "Snowflake",
    description: "Жемчужина Золотого кольца — город-музей под открытым небом с 53 храмами.",
    color: "#7A6B4A",
  },
  {
    id: "ekb",
    name: "Екатеринбург",
    subtitle: "Основан в 1723 году",
    image: "https://cdn.poehali.dev/projects/d6f85955-8cfe-4b44-937a-8f96d0f8ace6/files/252a81a0-87f7-42a2-89a2-e7fb35c44e18.jpg",
    quests: 7,
    places: 22,
    weather: "−9°C · Мороз",
    weatherIcon: "Thermometer",
    description: "Столица Урала на границе Европы и Азии — город заводов, декабристов и Романовых.",
    color: "#6B5A7A",
  },
];
...
const QUEST_STOPS: Record<number, string[]> = {
  ...
  6: ["Дворцовая площадь", "Эрмитаж", "Адмиралтейство", "Медный всадник", "Исаакиевский собор", "Казанский собор"],
  7: ["Невский проспект", "Аничков мост", "Гостиный двор", "Дом книги", "Площадь Островского"],
  8: ["Казанский Кремль", "Мечеть Кул-Шариф", "Башня Сююмбике", "Благовещенский собор", "Дворец земледельцев"],
  9: ["Кремль Новгорода", "Софийский собор", "Владычный двор", "Грановитая палата", "Ярославово Дворище"],
  10: ["Суздальский Кремль", "Спасо-Евфимиев монастырь", "Покровский монастырь", "Торговая площадь"],
  11: ["Плотинка", "Набережная городского пруда", "Дом Севастьянова", "Ипатьевский дом", "Вознесенская горка"],
};
...
const QUESTS = [
  ...
  { id: 6, city: "spb", title: "Дворцовая набережная", description: "От Зимнего дворца до Медного всадника — парадный Петербург Петра и Екатерины.", duration: "3 ч", stops: 6, difficulty: "Лёгкий", done: 0, total: 6 },
  { id: 7, city: "spb", title: "Невский проспект", description: "Главная артерия северной столицы — литература, архитектура и торговля.", duration: "2 ч", stops: 5, difficulty: "Лёгкий", done: 0, total: 5 },
  { id: 8, city: "kzn", title: "Казанский Кремль", description: "Единственный в мире кремль, где мирно соседствуют мечеть и православный собор.", duration: "2.5 ч", stops: 5, difficulty: "Лёгкий", done: 0, total: 5 },
  { id: 9, city: "vng", title: "Новгородский Кремль", description: "Детинец — старейший кремль России и центр вечевой республики.", duration: "2 ч", stops: 5, difficulty: "Лёгкий", done: 0, total: 5 },
  { id: 10, city: "szl", title: "Золотое кольцо Суздаля", description: "Монастыри, торжок и белокаменные храмы — история в каждом камне.", duration: "3 ч", stops: 4, difficulty: "Средний", done: 0, total: 4 },
  { id: 11, city: "ekb", title: "Литературный квартал", description: "Купеческий Екатеринбург: усадьбы, заводские конторы и дом последних Романовых.", duration: "2.5 ч", stops: 5, difficulty: "Средний", done: 0, total: 5 },
];
...
const MAP_POINTS = [
  ...
  { id: 9, city: "spb", label: "Дворцовая площадь", x: 50, y: 38, active: false },
  { id: 10, city: "spb", label: "Эрмитаж", x: 42, y: 45, active: false },
  { id: 11, city: "spb", label: "Петропавловская крепость", x: 55, y: 30, active: false },
  { id: 12, city: "spb", label: "Невский проспект", x: 62, y: 55, active: false },
  { id: 13, city: "kzn", label: "Казанский Кремль", x: 45, y: 35, active: false },
  { id: 14, city: "kzn", label: "Мечеть Кул-Шариф", x: 38, y: 42, active: false },
  { id: 15, city: "kzn", label: "Башня Сююмбике", x: 52, y: 40, active: false },
  { id: 16, city: "vng", label: "Детинец", x: 42, y: 40, active: false },
  { id: 17, city: "vng", label: "Софийский собор", x: 38, y: 48, active: false },
  { id: 18, city: "vng", label: "Ярославово Дворище", x: 58, y: 44, active: false },
  { id: 19, city: "szl", label: "Суздальский Кремль", x: 44, y: 42, active: false },
  { id: 20, city: "szl", label: "Спасо-Евфимиев монастырь", x: 55, y: 35, active: false },
  { id: 21, city: "szl", label: "Покровский монастырь", x: 35, y: 58, active: false },
  { id: 22, city: "ekb", label: "Плотинка", x: 50, y: 44, active: false },
  { id: 23, city: "ekb", label: "Ипатьевский дом", x: 38, y: 55, active: false },
  { id: 24, city: "ekb", label: "Вознесенская горка", x: 60, y: 38, active: false },
];
...
const FACTS = [
  ...
  { id: 6, city: "spb", text: "Эрмитаж — второй по величине художественный музей в мире. Чтобы осмотреть все экспонаты, потребуется около 8 лет.", emoji: "🖼️" },
  { id: 7, city: "spb", text: "Санкт-Петербург стоит на 42 островах, образованных 93 реками и каналами. В городе более 300 мостов.", emoji: "🌉" },
  { id: 8, city: "kzn", text: "Казань — единственный город в мире, где православный собор и мечеть стоят в одном кремле бок о бок.", emoji: "🕌" },
  { id: 9, city: "vng", text: "Великий Новгород — первый город России, где зародилось вечевое самоуправление: горожане голосовали за правителей.", emoji: "🔔" },
  { id: 10, city: "szl", text: "В Суздале на 10 000 жителей приходится 53 церкви — больше, чем в любом другом городе России по соотношению.", emoji: "⛪" },
  { id: 11, city: "ekb", text: "Екатеринбург стоит ровно на границе Европы и Азии. Прямо в черте города установлен обелиск «Европа–Азия».", emoji: "🌍" },
];
